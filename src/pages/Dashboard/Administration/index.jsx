                ...
                <div style={{ backgroundSize: '80%' }}>
                    ...
                    <AdmContainer>
                        ...
                        <EventCard style={{position:'relative'}}>
                            <img style={{ maxWidth: '100%', maxHeight: '100%',height:'100%', borderRadius: 10, objectFit: 'cover' }} src={eventData?.backgroundImageUrl} alt="background-image" />
                            <CardImg style={{position:'absolute'}}>
                                <img
                                    style={{ borderRadius: '50%', position: 'absolute', left: 10, bottom: 10, width: 50, height: 50, objectFit: 'cover' }}
                                    className="logo"
                                    src={eventData?.logoImageUrl}
                                    alt="background"
                                />
                                <h2 style={{ color:'white', position:'absolute',left:'10px',top:'10px'}}>{eventData?.title}</h2>
                            </CardImg>
                            <CardDates style={{ position: 'absolute', left: 10, bottom: 10, width: '100%', height: 50, objectFit: 'cover', }} >
                                <h4 style={{color:'white'}}>Start Date:  <span>{eventData?.startsAt}</span> </h4>
                                <h4 style={{color:'white'}}>End Date:  <span>{eventData?.endsAt}</span></h4>
                            </CardDates>
                        </EventCard>
                    </AdmContainer>
                </div>
